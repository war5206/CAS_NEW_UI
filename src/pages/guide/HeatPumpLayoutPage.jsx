...
import { COUPLE_ENERGY_TYPE_NONE_ID } from '@/config/couplingEnergyTypes'
...
function HeatPumpLayoutPage() {
  ...
  const resolvedCoupleEnergyTypeId = coupleEnergyTypeId ?? COUPLE_ENERGY_TYPE_NONE_ID
  const resolvedCoupleEnergyNumber = coupleEnergyNumber ?? '0'
